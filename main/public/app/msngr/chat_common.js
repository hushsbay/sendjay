...
const addRow = (obj, kind) => {
    ...
    if (obj.type == "invite" || obj.type == "leave") {
        ...
        if (obj.senderid == g_userid) { //sent
            ...
            // _html += "      <img id=cellmenu_" + obj.msgid + " src='/img/menu.png' class=coImg12 style='display:none;margin:0px 4px 0px 0px'>"
            // _html += "      <img id=reply_" + obj.msgid + " src='/img/reply.png' class=coImg12 style='display:none;margin:0px 4px 0px 0px'>"
            // _html += "      <img id=save_" + obj.msgid + " src='/img/download.png' class=coImg12 style='display:none;margin:0px 4px 0px 0px'>"
            //_html += "      <span id=save_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>저장</span>" 
            //_html += "      <span id=reply_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>답장</span>"   
            //_html += "      <span id=cellmenu_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>메뉴</span>"   
            //_html += "  </div>"
            _html += "</div>"
        } else { //received
            ...
            // _html += "      <img id=cellmenu_" + obj.msgid + " src='/img/menu.png' class=coImg12 style='margin:0px 0px 0px 4px'>"
            // _html += "      <img id=reply_" + obj.msgid + " src='/img/reply.png' class=coImg12 style='margin:0px 0px 0px 4px'>"
            // _html += "      <img id=save_" + obj.msgid + " src='/img/download.png' class=coImg12 style='margin:0px 0px 0px 4px'>"
            //_html += "      <span id=cellmenu_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>메뉴</span>"   
            //_html += "      <span id=reply_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>답장</span>"   
            //_html += "      <span id=save_" + obj.msgid + " class=mq_tiny style='display:none;cursor:pointer;background:#005192;color:white;border-radius:5px;padding:5px'>저장</span>"
            //_html += "  </div>"
...
function procInvite(useridArr, usernmArr) { //invoked from main.html (invite) popup or mobile
